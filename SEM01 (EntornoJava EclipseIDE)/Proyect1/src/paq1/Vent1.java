...
public class Vent1 extends JFrame implements ActionListener {
	...
	public Vent1() {
		...
		btnProcesar.setBounds(164, 11, 95, 34);
		contentPane.add(btnProcesar);
		
		txtS = new JTextArea();
		txtS.setEditable(false);
		txtS.setBounds(37, 56, 378, 176);
		contentPane.add(txtS);
		
		rdbtnNewRadioButton = new JRadioButton("Masculino");
		rdbtnNewRadioButton.setBounds(37, 246, 109, 23);
		contentPane.add(rdbtnNewRadioButton);
		
		rdbtnNewRadioButton_1 = new JRadioButton("Femenino");
		rdbtnNewRadioButton_1.setBounds(37, 272, 109, 23);
		contentPane.add(rdbtnNewRadioButton_1);
		
		comboBox = new JComboBox();
		comboBox.setBackground(new Color(192, 192, 192));
		comboBox.setBounds(152, 246, 124, 22);
	...
	protected void do_btnProcesar_actionPerformed(ActionEvent e) {
		txtS.append("Mi primera clase con Java\n");
		txtS.append("Mi nombre es: Chris");
